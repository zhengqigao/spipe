...
**477 checks, and the exit status is 0 only if every one passed**, so it drops straight
into CI. `--quick` runs the fast ~340 of them in about a minute and a half. Almost all of it needs
